...
electron_1.contextBridge.exposeInMainWorld('electronAPI', {
    ...
    getCampaignRecipients: (campaignId) => electron_1.ipcRenderer.invoke('get-campaign-recipients', campaignId),
    saveCampaignRecipients: (campaignId, contactIds) => electron_1.ipcRenderer.invoke('save-campaign-recipients', { campaignId, contactIds }),
    ...
    deleteCampaign: (campaignId) => electron_1.ipcRenderer.invoke('delete-campaign', campaignId),
    archiveCampaign: (campaignId) => electron_1.ipcRenderer.invoke('archive-campaign', campaignId),
    // Group API
